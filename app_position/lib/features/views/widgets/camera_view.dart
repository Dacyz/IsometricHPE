...
class _CameraViewState extends State<CameraView> {
  ...
  Widget _liveFeedBody() {
    if (_cameras.isEmpty) return const SizedBox();
  ...
  Future _startLiveFeed() async {
    ...
    final minExposureOffset = await _controller?.getMinExposureOffset();
    if (minExposureOffset != null) {
      _minAvailableExposureOffset = minExposureOffset;
    }
    final maxExposureOffset = await _controller?.getMaxExposureOffset();
    if (maxExposureOffset != null) {
      _maxAvailableExposureOffset = maxExposureOffset;
    }
